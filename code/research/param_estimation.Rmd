...
#pdf(file = "../../tex/mag/img/arfi_est_phi1.pdf", width = 12, height = 3.5, pointsize = 15)
#plot_arfi(res_arfi1$`N = 100`, phi)
#dev.off()

pdf(file = "../../tex/mag/img/arfi_est_phi1.pdf", width = 12, height = 6, pointsize = 15)
...
pdf(file = "../../tex/mag/img/arfi_est_phi5.pdf", width = 12, height = 6, pointsize = 15)
...
pdf(file = "../../tex/mag/img/arfi_est_phi9.pdf", width = 12, height = 6, pointsize = 15)
...
mse_arfima_d <- sapply(seq_along(ds), function(i) mse(res_arfi3$`N = 1000`[[i]]$arfima.d, ds[i]))
mse_arfima_phi <- sapply(seq_along(ds), function(i) mse(res_arfi3$`N = 1000`[[i]]$arfima.phi, phi))

mse_arfima_centered_d <- sapply(seq_along(ds), function(i) mse(res_arfi3$`N = 1000`[[i]]$arfima_centered.d, ds[i]))
mse_arfima_centered_phi <- sapply(seq_along(ds), function(i) mse(res_arfi3$`N = 1000`[[i]]$arfima_centered.phi, phi))

mse_fracdiff_d <- sapply(seq_along(ds), function(i) mse(res_arfi3$`N = 1000`[[i]]$fracdiff.d, ds[i]))
mse_fracdiff_phi <- sapply(seq_along(ds), function(i) mse(res_arfi3$`N = 1000`[[i]]$fracdiff.phi, phi))

mse_whittle_d <- sapply(seq_along(ds), function(i) mse(res_arfi3$`N = 1000`[[i]]$whittle.d, ds[i]))
mse_whittle_phi <- sapply(seq_along(ds), function(i) mse(res_arfi3$`N = 1000`[[i]]$whittle.phi, phi))

bias_arfima_d <- sapply(seq_along(ds), function(i) bias(res_arfi3$`N = 1000`[[i]]$arfima.d, ds[i]))
bias_arfima_phi <- sapply(seq_along(ds), function(i) bias(res_arfi3$`N = 1000`[[i]]$arfima.phi, phi))
