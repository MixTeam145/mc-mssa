...
pdf(file = "../../tex/mag/img/fi_est_N100.pdf", width = 12, height = 4)
plot_fi(res_fi$`N = 100`)
dev.off()

# plot_fi(res_fi$`N = 500`)

pdf(file = "../../tex/mag/img/fi_est_N1000.pdf", width = 12, height = 4)
...
```{r, fig.width=12, fig.height=4}
pdf(file = "../../tex/mag/img/ar1_est_N100.pdf", width = 12, height = 4)
plot_ar1(res_ar1$`N = 100`)
dev.off()

# plot_ar1(res_ar1$`N = 500`)

pdf(file = "../../tex/mag/img/ar1_est_N1000.pdf", width = 12, height = 4)
...
```{r}
r <- lapply(ds, function(d) arfi_est(phi, d, 5000))
names(r) <- names_ds
res_arfi3[["N = 5000"]] <- r
```
...
plot_arfi(res_arfi3$`N = 5000`, phi)
```
