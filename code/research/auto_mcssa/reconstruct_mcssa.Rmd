...
s <- ssa(f, 96, kind = "1d-ssa", svd.method = "svd")
...
set.seed(10)
r <- auto_mcssa(f, 48, 96, trend_freq = 0, rank = 30, fixed = list(phi = NA, d = 0))

# pdf("../../tex/science2025/img/auto_mcssa_result.pdf", width = 8, height = 4)
r_plot <- autoplot(ts(signal), series="Signal", ylab = "") +
  autolayer(ts(r$signal), series = "Signal Estimate")

ggsave("../../../tex/master/img/auto_mcssa_result1.pdf", r_plot, device = "pdf", width = 8, height = 4) 
