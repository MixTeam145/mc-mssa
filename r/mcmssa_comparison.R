...
# ROC AUC
auc(roc.me1sum.ev[[5]]$fpr, roc.me1sum.ev[[5]]$tpr, xlim = c(0, 0.5))
auc(roc.me1sum.fa[[5]]$fpr, roc.me1sum.fa[[5]]$tpr, xlim = c(0, 0.5))
auc(roc.me1block.ev[[2]]$fpr, roc.me1sum.ev[[2]]$tpr, xlim = c(0, 0.5))
auc(roc.me1block.fa[[4]]$fpr, roc.me1block.fa[[4]]$tpr, xlim = c(0, 0.5))

# a_I AUC
auc(alpha_1.me1sum.ev[[5]]$alpha, alpha_1.me1sum.ev[[5]]$fpr)
auc(alpha_1.me1sum.fa[[5]]$alpha, alpha_1.me1sum.fa[[5]]$fpr)
auc(alpha_1.me1block.ev[[2]]$alpha, alpha_1.me1block.ev[[2]]$fpr)
auc(alpha_1.me1block.fa[[4]]$alpha, alpha_1.me1block.fa[[4]]$fpr)
