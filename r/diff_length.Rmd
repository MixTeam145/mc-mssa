...
beta_L10 <- lapply(p.values_signal_L10, function(pvals) sapply(alphas, function(a) mean(pvals < a)))
```
...
beta_L40 <- lapply(p.values_signal_L40, function(pvals) sapply(alphas, function(a) mean(pvals < a)))
```
