...
\begin{equation}\label{eq:snr}
	\operatorname{SNR}(\mathsf{S}, \bm\xi)=\frac1N\sum_{j=0}^{N-1}\frac{I_{\mathsf{S}}(j/N)}{f_{\bm{\xi}}(j/N)}
\end{equation}
соотношением сигнал-шум, где $I_{\mathsf{S}}(\omega)$~--- периодограмма сигнала, $f_{\bm\xi}(\omega)$~--- спектральная плотность шума.	
\end{definition}
