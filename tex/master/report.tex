...
\begin{figure}[h]
	\centering
	\subcaptionbox{$\textrm{ARFIMA}(0, d, 0)$\label{fig:IrelandWind_mcssa_fi}}{\includegraphics[width=\textwidth]{img/IrelandWind_mcssa_fi.pdf}}
	\subcaptionbox{$\textrm{ARFIMA}(1, d, 0)$\label{fig:IrelandWind_mcssa_arfi}}{\includegraphics[width=\textwidth]{img/IrelandWind_mcssa_arfi.pdf}}
